...
public class TC004_Put_UpdateSingle_EmployeeData extends TestBase{
	
	String empName=RestUtils.empName();
	String empEmail=RestUtils.empEmail();
	
	@BeforeClass
	public void updateSingleEmployeeData() throws InterruptedException
	{
		logger.info("***********Started TC004_Put_UpdateSingle_EmployeeData*********");
	...
	{
		logger.info("***********Finished TC004_Put_UpdateSingle_EmployeeData*********");
	}
